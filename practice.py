...
#     if balance >= money :
#         print("출금이 완료 잔액은 {0}원 입니다. " .format(balance - money))
#         return balance - money
#     else:
...
# # 나이와 같은 언어 일떄 ( 기본값으로 매개변수에 값을 저장)
...
# #키워드 순서대로 호출하지 않고 직접 키워드에 데이터를 넣어 호출 할수있다. 
# def profile(name , age , main_lang):
#     print(name , age , main_lang)

# profile(name="유" , main_lang="파이썬" , age=20)
# profile(main_lang="파이썬" ,name="유" , age=20)
...
#         print(lang, end=" ")
#     print()
# profile("유" ,20 , "Python" , "java" ,"C" ,"C++" , "C#" , "C#" , "C#" )
# profile("김" ,24 , "Python" , "java" )

# # 지역 변수 전역 변수 

# gun = 10 # 지역 변수 
# def checkpoint(soldiers):
#     global gun # 전역 공간에 있는 gun 사용  위에 선언된 지역변수의 값을 사용할 수 있다.
#     gun = gun - soldiers
